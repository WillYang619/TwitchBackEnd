...
public class ApplicationConfig {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan("com.wetech.twitch.entity.db");
    ...
    public DataSource dataSource() {
        String RDS_ENDPOINT = "twitch.cmjbu6t0im82.us-east-1.rds.amazonaws.com";
        String USERNAME = "admin";
        String PASSWORD = "06191989yw";
